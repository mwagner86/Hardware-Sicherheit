...
\large Der Noisy-Neighbor-Effekt: Untersuchung mikroarchitektonischer Ressourcen-Interferenzen}
...
Der Fokus liegt auf aktuellen Hardware-Mitigierungen gegen den Noisy-Neighbor-Effekt sowie den zugehörigen regulatorischen Anforderungen. Das NIST \cite{nist2014hypervisor} stuft fehlende Plattform-Isolation in Server-Umgebungen als kritisches Risiko ein. Selva et al. \cite{selva2017performance} und Chintapalli et al. \cite{chintapalli2022numasfp} untersuchen die Effektivität von Mechanismen wie der Intel Cache Allocation Technology (CAT) zur Isolation von LLC-Ressourcen. Pinto et al. \cite{pinto2025esther} fassen den aktuellen Forschungsstand zu hardwaregestütztem QoS-Enforcement zusammen.

\subsection{Wissenschaftliche Publikationen}
Diese Publikationen dienen der theoretischen Fundierung der Arbeit und der Einordnung der untersuchten Schwachstellen. Koh et al. \cite{koh2007analysis} liefern grundlegende Untersuchungen zu Leistungsinterferenzen in virtuellen Umgebungen. Vaucher et al. \cite{vaucher2015hypervisor} differenzieren bei der Analyse von Performance-Einbußen zwischen Hardware-Cache-Effekten und Hypervisor-Scheduling. Ge et al. \cite{ge2018survey} ordnen Angriffe auf geteilte Caches in eine allgemeine Taxonomie ein. Gajanin et al. \cite{gajanin2025performance} untersuchen entsprechende Denial-of-Service-Risiken in aktuellen Cloud-Architekturen.
